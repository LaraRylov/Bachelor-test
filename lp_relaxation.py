...
# Variables
    a = m.addVars(self.p, self.index_branch_nodes, lb=0, ub=1, vtype=GRB.CONTINUOUS, name='a')        # splitting feature: over indgang, branchnodes
    d = m.addVars(self.index_branch_nodes, lb=0, ub=1, vtype=GRB.CONTINUOUS, name='d')                # giver 1, hvis node t splitter og 0 hvis ikke
    b = m.addVars(self.index_branch_nodes, vtype=GRB.CONTINUOUS, name='b')            # højresiden, når vi splitter
    z = m.addVars(self.n, self.index_leaf_nodes, lb=0, ub=1, vtype=GRB.CONTINUOUS, name='z')          # leaf node assignment
    l = m.addVars(self.index_leaf_nodes, lb=0, ub=1, vtype=GRB.CONTINUOUS, name='l')                  # giver 1, hvis der er mindst et punkt i bladet og 0 ellers
    ...
    c = m.addVars(self.labels, self.index_leaf_nodes, lb=0, ub=1, vtype=GRB.CONTINUOUS, name='c')     # giver 1, hvis label k er givet til blad t og 0 ellers
